...
import static org.example.constructor.ApiConstants.PUBLIC_V1_COMMENTS;

@RestController
@RequestMapping(PUBLIC_V1_COMMENTS)
...
public class PublicCommentController {
    ...
    @CommonErrorApiResponsesWith404
    public ResponseEntity<ResponseCommentDTO> createCommentForDeveloper(@PathVariable("taskId") Long taskId, @RequestBody RequestCommentDTO requestCommentDTO) {
